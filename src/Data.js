...
export  const DataNilai = [
  ...
  },
  {
    ...
    desc: "Selalu mengedepankan etika dan profesionalisme dalam semua tindakan bisnisnya",
    url: require("./assets/Nilai/2.png"),
  },
  {
    nama: "INOVASI",
    desc: "Selalu berusaha untuk menciptakan solusi baru dan terdepan dalam menyediakan produk-produk ayam yang berkualitas tinggi",
    url: require("./assets/Nilai/3.png"),
  },
  {
    nama: "LINGKUNGAN",
    desc: "Peduli terhadap lingkungan dan selalu mengedepankan praktik-praktik bisnis yang ramah lingkungan",
    url: require("./assets/Nilai/4.png"),
  },
  {
    nama: "KESEJAHTERAAN PETERNAK",
    desc: "Selalu menghargai kontribusi peternak ayam dan selalu memperhatikan kesejahteraan mereka",
    url: require("./assets/Nilai/5.png"),
  },
  {
    nama: "SOSIAL",
    desc: "Selalu memperhatikan dampak bisnisnya terhadap masyarakat dan berkontribusi positif bagi pemberdayaan masyarakat",
...
export const DataMisi = [
  ...
  },
  {
    ...
    desc: "Menjaga kesejahteraan peternak ayam dan meningkatkan produktivitas peternakan",
  },
  {
    url: require("./assets/Misi/3.png"),
    desc: "Meningkatkan efisiensi dalam proses kerja dan sistem produksi    ",
  },
  {
    url: require("./assets/Misi/4.png"),
    desc: "Mengadopsi praktik-praktik bisnis yang ramah lingkungan",
  },
  {
    url: require("./assets/Misi/5.png"),
    desc: "Mengembangkan program-program sosial yang bermanfaat bagi masyarakat",
  },
  {
    url: require("./assets/Misi/6.png"),
    desc: "Meningkatkan keuntungan perusahaan secara konsisten",
  },
];
...
export const DataSectionProduct = [
  {
    ...
    desc: 'DOC atau singkatan dari "Day Old Chick" merupakan sebutan untuk bibit ayam. DOC parent stock nantinya akan menjadi ayam yang akan menghasilkan ayam broiler.Kami memfasilitasi pasokan DOC Parent Stock yang tersedia untuk distribusi ke industri peternakan ayam di seluruh Indonesia. Kami menyadari bahwa peternak memerlukan bibit ayam broiler berkualitas, sehingga kami hanya menyediakan DOC terbaik.',
  },
  {
    id: "docfs",
    nama: "DAY OLD CHICK (DOC) - FINAL STOCK",
    url: require("./assets/Product/FS.jpg"),
    desc: 'DOC atau singkatan dari "Day Old Chick"merupakan sebutan untuk bibit ayam. DOC final stock nantinya akan dibesarkan menjadi ayam broiler komersil. Kami memfasilitasi pasokan DOC final stock yang berkualitas  dan terbaik untuk distribusi ke seluruh konsumen di wilayah Jawa dan Bali.',
  },
  {
    id: "broiler",
    nama: "AYAM HIDUP BROILER KOMERSIAL",
    url: require("./assets/Product/Broiler.jpg"),
    desc: "Ayam broiler merupakan ayam komersial yang digunakan sebagai ayam konsumsi. Kami menyediakan ayam broiler komersial dengan keadaan hidup untuk menjamin kualitas dan kesegaran supaya dapat diolah secara industri menjadi ayam potong. Ayam ini dipelihara dengan memperhatikan suhu dan kualitas kandang serta pakan yang menjamin mutu produk.",
  },
  {
    id: "telur",
    nama: "TELUR KOMERSIAL",
    url: require("./assets/Product/Telur.jpg"),
    desc: "Telur komersial merupakan telur yang digunakan untuk keperluan konsumsi. Telur komersial Janu Putra Sejahtera dihasilkan dari peternakan ayam petelur yang berkualitas, dengan standar dan sistem yang baik, efisien, dan terintegrasi menjamin kualitas dari telur yang kami produksi.",
  },
  {
    id: "karkas",
    nama: "KARKAS AYAM",
    url: require("./assets/Product/Karkas.jpg"),
    desc: "Karkas ayam atau ayam potong merupakan hasil produksi dari ayam broiler komersial yang telah melalui proses di rumah potong. Ayam yang akan didistribusikan untuk industri makanan ini terjamin keamanan, kualitas, serta kehalalannya karena telah melalui proses produksi yang ketat disertai dengan pengoptimalan teknologi terbaik kami.",
  },
];
...
export const DataSectionBusiness = [
  {
    ...
    desc: "Peternakan pembibitan ayam parent stock adalah suatu tempat yang digunakan untuk membibitkan atau mengembangbiakkan ayam dewasa yang digunakan sebagai ayam induk (parent stock) untuk produksi telur atau ayam potong. Ayam dewasa yang digunakan sebagai ayam induk ini disebut juga dengan ayam breeder.",
  },
  {
    id: "broiler",
...
export const DataLinkBusiness = [
  {
    ...
    nama: "Peternakan Pembibitan",
    par1: "Peternakan pembibitan ayam parent stock adalah suatu tempat yang digunakan untuk membibitkan atau mengembangbiakkan ayam dewasa yang digunakan sebagai ayam induk (parent stock) untuk produksi telur atau ayam potong. Ayam dewasa yang digunakan sebagai ayam induk ini disebut juga dengan ayam breeder.",
    par2: "Peternakan pembibitan ayam parent stock yang ada di Ngawis terdiri dari 9 kandang, sedangkan di Purbalingga terdiri dari 20 kandang. Jika setiap kandang berkapasitas 10000 ekor ayam, maka jumlah ayam di peternakan pembibitan ayam parent stock di Ngawis adalah sebanyak 90000 ekor ayam, sedangkan di Purbalingga adalah sebanyak 200000 ekor ayam.",
    par3: "Peternakan pembibitan ayam parent stock biasanya menjadi tahap awal dalam proses produksi telur atau ayam potong. Ayam yang dihasilkan dari peternakan pembibitan ayam parent stock ini kemudian dikirim ke peternakan pembesaran (grower farm) untuk dikembangbiakkan lebih lanjut sampai siap untuk dipasarkan",
  },
  {
    path: "broiler",
  ...
  },
  {
    ...
    par3: "Dalam proses penetasan telur, faktor-faktor seperti suhu, kelembaban, dan waktu dipertimbangkan secara cermat untuk memastikan hasil yang optimal. Setelah penetasan, telur ditangani dengan hati-hati dan diteruskan ke proses berikutnya dengan benar. Penjaminan mutu dan pengujian rutin harus dilakukan untuk memastikan bahwa hasil penetasan memenuhi standar kualitas yang ditetapkan.",
  },
  {
    path: "rpa",
