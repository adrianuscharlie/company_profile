...
export const DataProduk=[
    {nama:"DOC Parent Stock",url:require("./assets/Produk/1.png")},
    {nama:"DOC Final Stock",url:require("./assets/Produk/2.png")},
    {nama:"Ayam Hidup",url:require("./assets/Produk/3.png")},
    {nama:"Karkas Ayam",url:require("./assets/Produk/4.png")},
    {nama:"Telur Komersil",url:require("./assets/Produk/5.png")},
]

export const DataNilai=[
    {nama:"KUALITAS",desc:"Selalu mengedepankan kualitas dalam semua aspek bisnisnya, mulai dari produk hingga pelayanan kepada konsumen",url:require("./assets/Nilai/1.png")},
    {nama:"PROFESIONALISME",desc:"Selalu mengedepankan etika dan profesionalisme dalam semua tindakan bisnisnya",url:require("./assets/Nilai/2.png")},
    {nama:"INOVASI",desc:"Selalu berusaha untuk menciptakan solusi baru dan terdepan dalam menyediakan produk-produk ayam yang berkualitas tinggi",url:require("./assets/Nilai/3.png")},
    {nama:"LINGKUNGAN",desc:"Peduli terhadap lingkungan dan selalu mengedepankan praktik-praktik bisnis yang ramah lingkungan",url:require("./assets/Nilai/4.png")},
